...
const MUST_BE_DYNAMIC = [
  ...
  "cases/layout.tsx",
  "cases/[slug]/page.tsx",
  // Страница отдела (DEPT-SEO.2A): весь её текст принадлежит базе, запасного «состояния по
  // умолчанию» у неё нет. Статикой она уехала бы в образ с тем содержимым, которое было на сборке,
  // — то есть ни с каким, потому что базы на сборке не существует.
