 ...
 *
 * Продукты, кейсы и отделы не ограничиваются ничем: их связи публичный сайт пока не читает, и
 * правило, придуманное раньше потребителя, было бы догадкой.
 */
              ...
              <div className={styles.listItem} key={index}>
                <div className={styles.listItemBody}>
                  ...
                  <div className={styles.field}>
                    ...
                    {unavailable ? (
                      <span className={styles.hint}>
                        Этот материал сейчас не появится в блоке на странице. Снимите связь или
                        опубликуйте материал в этом разделе — иначе сохранение будет отклонено.
                      </span>
                    ) : null}
                  </div>
                </div>
