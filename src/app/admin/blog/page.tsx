 ...
 * неизвестен».
 *
 * `detail` — то, по чему владелец сайта узнаёт материал в выпадающем списке: обычно адрес.
 * У отдела адреса нет: отдел — состояние главной страницы, а не отдельный документ, поэтому
 * уточнением служит слово «отдел главной страницы».
 */
