...
| --------------------------------------------- | ---- | ------- | -------------------------------------------------- | ------------------------------------------------------------ | --------------------------------------------- | ---------------------------------------- | ------------------------------------------------------ | --- | --- | ------- |
| `/`                                           | 200  | index   | Автоматизируем продажи, поддержку и документы с п… | Находим ручные операции и потери между системами. Внедряем … | https://allqbit.ru                            | Автоматизируем продажи, поддержку и док… | Organization, WebSite, WebPage                         | да  | да  | да      |
| `/?department=sales`                          | 200  | index   | Автоматизируем продажи, поддержку и документы с п… | Находим ручные операции и потери между системами. Внедряем … | https://allqbit.ru                            | Автоматизируем продажи, поддержку и док… | Organization, WebSite, WebPage                         | да  | да  | да      |
| `/?department=support`                        | 200  | index   | Автоматизируем продажи, поддержку и документы с п… | Находим ручные операции и потери между системами. Внедряем … | https://allqbit.ru                            | Автоматизируем продажи, поддержку и док… | Organization, WebSite, WebPage                         | да  | да  | да      |
| `/?department=management`                     | 200  | index   | Автоматизируем продажи, поддержку и документы с п… | Находим ручные операции и потери между системами. Внедряем … | https://allqbit.ru                            | Автоматизируем продажи, поддержку и док… | Organization, WebSite, WebPage                         | да  | да  | да      |
| `/?department=hr`                             | 200  | index   | Автоматизируем продажи, поддержку и документы с п… | Находим ручные операции и потери между системами. Внедряем … | https://allqbit.ru                            | Автоматизируем продажи, поддержку и док… | Organization, WebSite, WebPage                         | да  | да  | да      |
| `/?department=logistics`                      | 200  | index   | Автоматизируем продажи, поддержку и документы с п… | Находим ручные операции и потери между системами. Внедряем … | https://allqbit.ru                            | Автоматизируем продажи, поддержку и док… | Organization, WebSite, WebPage                         | да  | да  | да      |
| `/?section=task`                              | 200  | index   | Автоматизируем продажи, поддержку и документы с п… | Находим ручные операции и потери между системами. Внедряем … | https://allqbit.ru                            | Автоматизируем продажи, поддержку и док… | Organization, WebSite, WebPage                         | да  | да  | да      |
