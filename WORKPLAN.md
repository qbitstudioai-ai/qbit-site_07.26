...
- Skeptic verdict: **round 1** (review плана после разбиения, Amendment 3) — `FAIL`: устаревшие
  ...
  поясняющий, что они используют "Step 5" в дореформенном значении. Ожидает **round 4**.
...
- Skeptic verdict: **round 1** (review плана после разбиения, Amendment 3) — `FAIL`, вместе со
  ...
  source-of-truth документе; исправлено). Ожидает **round 4**. Этот шаг выделен из бывшего единого
  черновика "Step 5 — Desktop 10/90 shell" по Amendment 3 (см. `DECISIONS.md` 2026-07-15 "OQ-D").
- Skeptic findings: см. Step 5 → Skeptic findings (общие находки round 1/2/3 на оба новых шага, так
